...
int main()
{
    ...
    //Math functions
    cout << "Round PI up: " << ceil(pi) << endl;
    cout << "Round PI down: " << floor(pi) << endl;
    cout << "Round PI to nearest integer: " << round(pi) << endl;
    cout << "pi ^ 2: " << pow(pi, 2) << endl;
    cout << "Absolute value of pi: " << abs(pi) << endl;

    //... There are many more (https://www.w3schools.com/cpp/cpp_math.asp)

    //Rounding
    //2 places
    cout << "PI, 2 places " << round(pi * 100) / 100 << endl;
    //3 places
    cout << "PI, 3 places " << round(pi * 1000) / 1000 << endl;
